...
const ConnectWMSForm = (props: FormProps) =>{
        ...
        WMSCapabilities.fromURL(request, options).then((result) => {
            ...
            if (flatLayers.length>0) {
                setTimeout(()=>{
                    ...
                    if (getMap) {
                        cInputs.format = getPreferredFormat(getMap.supportedFormats);
                        setFormats(getMap.supportedFormats);
                    }
                    cInputs.label = flatLayers[0].title;
    ...
    return (
        ...
        >
            ...
            <Grid container spacing={1}>
                ...
                <Grid item xs={12} sm={12}>
                    <FormControl fullWidth size="small" required>
                        ...
                        <Select
                            ...
                            value={inputs.targetLayers as any}
                            label="Layers"
                            name="targetLayers"
                            multiple
                            onChange={handleChange}
                ...
                <Grid item xs={12} sm={12}>
                    <FormControl fullWidth size="small" required>
                        <InputLabel id="projection-select-id" >Projection</InputLabel>
                        <Select
                            labelId="projection-select-id"
                            value={inputs.projection}
                            label="Select projection"
                            name="projection"
                            onChange={handleChange}
                            input={<OutlinedInput label="Projection" />}
                        >
                            {renderProjections}
                        </Select>
                    </FormControl>
